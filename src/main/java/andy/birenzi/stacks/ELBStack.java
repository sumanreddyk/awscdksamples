...
public class ELBStack extends Stack {
    ...
    public ELBStack(final Construct scope, final String id, final ELBProps props) {
        ...
        loadBalancer= ApplicationLoadBalancer.Builder.create(this, "webELB")
            .vpc(props.getVpc())
            .internetFacing(true)
            ...
            .protocol(ApplicationProtocol.HTTPS).build();
                ...
                loadBalancer.addListener("WebListener",webListener).addTargetGroups(id, AddApplicationTargetGroupsProps.builder().targetGroups(targetGroups).build());
        }
