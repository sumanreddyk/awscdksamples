...
public class MyUserData {
    ...
    public UserData getUserData() {
        ...
        String service = String.join("\n", "touch " + serviceName, "/bin/echo '[Unit]' >> " + serviceName,
                "/bin/echo 'Description=DuoDeviceManagementPortal' >> " + serviceName,
                "/bin/echo 'After=syslog.target' >> " + serviceName, "/bin/echo '[Service]' >> " + serviceName,
                ...
                "/bin/echo 'SuccessExitStatus=143' >> " + serviceName, "/bin/echo '[Install]' >> " + serviceName,
